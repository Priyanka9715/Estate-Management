...
<style>
 ...
 <?php include('nav.php'); ?>
    <!-- Page Content -->
	<center><h1>Update Services</h1></center><br><br>
	<div class="col-md-12">
          <div class="tile">
<div> 
...
<option value="">select Estate Supplies</option>
<?php
include("config.php");
$id=$_POST['id'];
				...
				<div class="col-lg-4 mb-4">
                  <div class="card h-100">
                     ...
                     <div class="card-footer">
                        <a href="mupservices.php?delid=<?php echo $id; ?>" class="btn btn-primary">Delete</a>
                     </div>
                  </div>
               </div>
	<?php
...
if(isset($_GET['delid']))
{
	...
	if(mysqli_query($con,$sql1))
	{
		echo "<script>
				...
				echo "<script> location.href='mupservices.php'; </script>";
	}
