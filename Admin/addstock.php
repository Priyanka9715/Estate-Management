    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6" style="margin-left:25%;">
          <div class="">
            <center><div class="tile-body"> 
              <input class="btn btn-primary mr-2 mb-2" type="submit" value="ADD STOCK" name="addstock">
            </div></center>
          </div><br><br>
        </div>
		</form>
		...
		<div class="page-header text-white bg-primary">
              <center><h2 class="mb-3 line-head" id="buttons">View Stock</h2></center>
          </div>
          <div class="tile">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td><button class="btn btn-outline-danger" name="delete" type="submit">Update</button></td>
				  </form>
