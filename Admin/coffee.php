...
<?php
include("config.php");
$sql0 = "select * from harvest where item='coffee' order by year desc";
...
<tr>
<td colspan="2" align="center"><h1><b>COFFEE (<?php echo $year; ?>)</b></h1><br>
...
<tr>
<th>Pesticide Quantity (in lts)</th>
<td><?php echo $pqty; ?></td>
</tr>
	...
	?>
		...
		<div class="pagination_bar">
			...
			<ul class="pagination justify-content-center">
				<li class="page-item">
				  <a class="page-link" href="pepper.php" aria-label="Previous">
					<span aria-hidden="true">&laquo;</span>
					<span class="sr-only">Previous</span>
				  </a>
				</li>
				<li class="page-item">
				  <a class="page-link" href="areca.php" aria-label="Next">
