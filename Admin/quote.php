  ...
  <head>
   ...
   <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Quotations Request's</h1>
	  ...
	  <div class="col-md-12">
		<div class="page-header text-white bg-primary">
              <center><h2 class="mb-3 line-head" id="buttons">View Quotation Request's</h2></center>
          </div>
          <div class="tile">
            <h3 class="tile-title">Quotation Request</h3>
            <table class="table table-hover">
              ...
              <tbody>
                <tr>
				  ...
				  <td>I want to know the cost of this Product</td>
                  <td>Thermometer</td>
                  <td>Gelio</td>
                  <td>20</td>
                  <form method="post" action="sendquote.php">
                  <td><button class="btn btn-outline-success" name="quote" type="submit">Send Quote</button></td>
				  </form>
				  <form method="post" action="invoicequote.php">
                  <td><button class="btn btn-outline-primary" name="quote" type="submit">View Quote</button></td>
				  </form>
                </tr>  
				<tr>
                  <td>02</td>
