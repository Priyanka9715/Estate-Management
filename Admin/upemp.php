...
$sql = "update employee set id='$_POST[id]',name='$_POST[name]',dob='$_POST[dob]',gender='$_POST[gender]',age='$age',cno='$_POST[cno]',email='$_POST[email]',salary='$_POST[salary]',password='$_POST[password]',address='$_POST[address]' where id='$_POST[id]'";
$query_run = mysqli_query($con,$sql);
if($query_run)
{ 
echo "<script>
