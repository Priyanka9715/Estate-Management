...
.app-title 
{
  ...
  <form action="" method="post">
	...
	<input type="text" name="expense" placeholder="Expense" pattern="[0-9]+" title="only numbers" required>
	<br>
	<label>Reason :</label><br>
	<input type="text" name="reason" placeholder="Enter Reason" pattern="^[a-zA-Z\s][a-zA-Z0-9-_\.\s]{1,120000}$" required>
	<br>
