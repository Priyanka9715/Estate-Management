...
<form action="empupdate.php" method="get">  
...
<select>  
<option value="Course">Designation</option>  
<option value="BCA">Planter</option>  
<option value="BBA">Sprayer</option>  
<option value="B.Tech">Cutter</option>  
<option value="MBA">Cleaner</option>  
<option value="MCA">Driver</option>  
<option value="M.Tech">Assistant</option>  
</select>  
</div>  
<div>  
<label>   
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 col">
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<ul class="footer_ul_amrc">
						...
						<li><a href="sevices.php">Our Services</a></li>
