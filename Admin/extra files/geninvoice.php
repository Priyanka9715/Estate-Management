      ...
      <div class="app-title">
            ...
            <section class="invoice">
			  <div class="row mb-4">
                ...
                <div class="col-6">
                  ...
                  <h5 class="text-right">Invoice No <i>#GSI01<?php /*echo $salesno; */?></i></h5>
                </div>
              </div>
              <div class="row invoice-info">
                ...
                <div class="col-4 text-right">To
                  <address class="text-right"><strong>Jack<?php/* echo $name; */?></strong><br>Phone : 9900778854<?php /*echo $phoneno; */?><br>Email : jack@gmail.com<?php /*echo $phoneno; */?><br></address>
                </div>
		...
		*/
		?>
					  ...
					  <td>02<?php/* echo $sl; */?></td>
                        <td>Puls Meter<?php/* echo $type;*/ ?></td>
                        <td>10<?php/* echo $qty; */?></td>
                        <td>1000<?php/* echo $price; */?></td>
                        <td>Rs. 10000<?php/* echo $total;*/ ?></td>
                      </tr>
					   <?php 
								/*	}
									}*/
			  ...
			  <div class="row invoice-info">
                ...
                <div class="col-4 text-right">
                  <address class="text-right"><br><h5><b><i>Final Total : Rs.15000<?php /*echo $finaltotal; */?></i></b><h5></address>
                </div>
