  ...
  <head>
   ...
   <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Send Quotation</h1>
          
        </div>
      </div>
         <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">Send Quotation</h3>
            <div class="tile-body">
              <form class="row" action="#" method="post">
				...
				<div class="form-group col-md-3">
                  ...
                  <input class="form-control" type="tel" name="phoneno" value="8547965874" required>
                </div>
				<div class="form-group col-md-3">
                  <label class="control-label">Name</label>
                  <input class="form-control" type="name" value="Shraddha"  name="name" required>
                </div>
		...
		<div class="col-md-12">
          <div class="tile">
            <div class="tile-title-w-btn">
              <h3 class="title">Quotation Details</h3>
            
            </div>
            <div class="tile-body">
              <h5>Bill No:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <i>QT01</i></h5>
              <h5>Name:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<i>Shraddha</i></h5>
              <h5>Phone No:&nbsp&nbsp&nbsp&nbsp<i>8547965874</i></h5>
