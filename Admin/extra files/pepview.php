...
<body>
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3">PEPPER
				<small>A brown colour magical substance</small>
			</h1>
		</div>
	</div>
    ...
    <div class="container">
		<div class="breadcrumb-main">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">PEPPER</li>
			</ol>
		</div>
		<form action="arecaupdate.php" method="get">
	<center>
<table allign="center" border="2" >
<tr>
<td colspan="2" align="center"><h1><b>PEPPER</b></h1></td>
</tr>
<tr>
<th>Area(in acres)</th>
...
<td><input type="number"></td>
		...
		<div class="pagination_bar">
			...
			<ul class="pagination justify-content-center">
				<li class="page-item">
				  <a class="page-link" href="coview.php" aria-label="Previous">
					<span aria-hidden="true">&laquo;</span>
					<span class="sr-only">Previous</span>
				  </a>
				</li>
				<li class="page-item">
				  <a class="page-link" href="arecaview.php" aria-label="Next">
        ...
        <div class="container bottom_border">
            <div class="row">
               <div class="col-lg-3 col-md-6 col-sm-6 col">
					...
					<!--headin5_amrc-->
					<p class="mb10">Estate  since the 1970s</p>
					<p><i class="fa fa-location-arrow"></i> 9878/25 sec 9 rohini 35 </p>
					<p><i class="fa fa-phone"></i> +91-9999878398 </p>
					<p><i class="fa fa fa-envelope"></i> aramane122@example.com </p>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6 col">
					...
					<ul class="footer_ul2_amrc">
						<li>
							...
							<p>Aranane<a href="#">https://www.aramanestate.com/</a></p>
						</li>
						<li>
							<a href="#"><i class="fab fa-twitter fleft padding-right"></i> </a>
							<p>Malnadu<a href="#">https://www.malenadu.com/</a></p>
						</li>
						<li>
							<a href="#"><i class="fab fa-twitter fleft padding-right"></i> </a>
