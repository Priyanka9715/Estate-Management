...
<form action="homebooked.php" method="get">  
...
<div>  
<label>   
Choose a room from a list:  
</label>   
<select>  
<option value="Course">Double cots non attached</option>  
<option value="BCA">Double cots attached</option>  
<option value="BBA">A.C. Room</option>  
<option value="B.Tech">Family (6cots)</option>  
<option value="MBA">Single Room</option>  
<option value="MCA">Extra Person</option>  
<option value="M.Tech">Ordinary Room</option>  
</select>  
</div>  
<div>  
<label>   
...
<input type="date" value="adate" name="date" checked >  
</div> 
<div>  
<label>   
Departure Date:  
</label><br>  
<input type="date" value="ddate" name="date" checked >  
</div> 
<label> 
<div>  
<label>   
...
<input type="number" value="num" name="num" checked >  
</div> 
<div>  
<label>   
Number of Children:  
