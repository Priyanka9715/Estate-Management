   ...
   <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
		...
		<li><a class="app-menu__item active" href="addstock.php"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Add Stock</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Update Stock</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
         <div class="tile">
            ...
            <div class="tile-body"> 
              <input class="form-control" type="date" name="date"  value="25-05-2022">
            </div>
          </div>
        </div>
		<div class="col-md-6">
         <div class="tile">
            ...
            <div class="tile-body"> 
              <input class="form-control" type="text" name="qty"  value="250" readonly>
            </div>
          </div>
        </div>
		<div class="col-md-6">
         <div class="tile">
            ...
            <div class="tile-body"> 
              <input class="form-control" type="text" name="price"  value="500">
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6" style="margin-left:25%;">
          <div class="">
            <center><div class="tile-body"> 
              <input class="btn btn-primary mr-2 mb-2" type="submit" value="UPDATE STOCK" name="addstock">
            </div></center>
          </div>
        </div>
		</form>
