...
<body>
	...
	<br>
	 <center><p><h1> What do you want to View...?
 <p>
   <div class="col-md-4">
  <a class="btn btn-lg btn-secondary btn-block"href="empupdate.php"><h2>Employees</h2></a><br>
  <a class="btn btn-lg btn-secondary btn-block"href="exdetails.php"><h2>Expenses</h2></a><br>
  <a class="btn btn-lg btn-secondary btn-block"href="harview.php"><h2>Harvesting Details</h2></a><br>
  <a class="btn btn-lg btn-secondary btn-block" href="serivebook.php"><h2>Service Bookings</h2></a><br>
  <a class="btn btn-lg btn-secondary btn-block" href="homebook.php"><h2>Homestay Bookings</h2></a><br>
   <a class="btn btn-lg btn-secondary btn-block" href="getjob.php"><h2>Job Applications</h2></a><br>
   <a class="btn btn-lg btn-secondary btn-block" href="receive.php"><h2>Requests</h2></a><br>
  </p>
  </div>
  </center>
</form>
               ...
               <div class="col-lg-3 col-md-6 col-sm-6 col">
					...
					<ul class="footer_ul2_amrc">
						<li>
							...
							<p>Aramane Estate<a href="#">https://www.aramane.com/</a></p>
						</li>
						<li>
							<a href="#"><i class="fab fa-twitter fleft padding-right"></i> </a>
							<p>Malanadu Estate<a href="#">https://www.malnaduestates.com/</a></p>
						</li>
						<li>
							<a href="#"><i class="fab fa-twitter fleft padding-right"></i> </a>
							<p>Karnataka<a href="#">https://www.karnataka.com/</a></p>
						</li>
					</ul>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					...
					<ul class="footer_ul_amrc">
						...
						<li><a href="manlist.php">Our Team </a></li>
