...
<body>
	...
	<br>
	 <center><p><h1> What do you want to Update...?
 <p>
   <div class="col-md-4">
  <a class="btn btn-lg btn-secondary btn-block"href="empdetails.php"><h2>Employees</h2></a><br>
  <a class="btn btn-lg btn-secondary btn-block"href="expenses.php"><h2>Expenses</h2></a><br>
  <a class="btn btn-lg btn-secondary btn-block"href="wages.php"><h2>Monthly Wages</h2></a><br>
  <a class="btn btn-lg btn-secondary btn-block" href="homeupdate.php"><h2>Homestay</h2></a><br>
  </p>
  </div>
  </center>
</form>
