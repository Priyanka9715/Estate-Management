   ...
   <body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
		...
		<li><a class="app-menu__item active" href="inward.php"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Inward Stock</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Inward Stock</h1>
      ...
      <div class="row">
            ...
            <div class="tile-body"> 
              <select class="form-control" name="stockname">
                <optgroup label="Select Stock type">
                  <option value="food">Surgical Kit</option>
                  <option value="medicine">Mask</option>
				  <option value="medicine">Pulse Meter</option>
                  <option value="bird">Hand Glows</option>
                </optgroup>
              </select>
            </div>
          </div>
        ...
        <div class="col-md-6">
         <div class="tile">
            ...
            <div class="tile-body"> 
              <input class="form-control" type="text" name="Seller" required>
            </div>
          </div>
        </div>
		<div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="tile">
            ...
            <div class="tile-body"> 
              <input class="btn btn-primary mr-2 mb-2" type="submit" value="Add Inward" name="inward">
		...
		<div class="page-header text-white bg-primary">
              <center><h2 class="mb-3 line-head" id="buttons">View Inward Stock</h2></center>
          </div>
          <div class="tile">
            <h3 class="tile-title">Inward Stock Details</h3>
