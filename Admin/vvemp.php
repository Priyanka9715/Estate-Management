...
while($row0=mysqli_fetch_array($query_run0))
{
    ...
    <tr>
			...
			<td><a href="vvemp.php?delid=<?php echo $id; ?>"><button style="background-color:red; color:white;">Delete</button></a></td>
	</tr>
	<?php
}
}
...
$sql = "delete from manager where id='".$delid."'";
...
echo "<script> location.href='vvemp.php'; </script>";
}
}
