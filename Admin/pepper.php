...
<?php
include("config.php");
$sql0 = "select * from harvest where item='pepper' order by year desc";
...
<tr>
<td colspan="2" align="center"><h1><b>PEPPER (<?php echo $year; ?>)</b></h1><br>
	...
	?>
		...
		<div class="pagination_bar">
			...
			<ul class="pagination justify-content-center">
				<li class="page-item">
				  <a class="page-link" href="areca.php" aria-label="Previous">
					<span aria-hidden="true">&laquo;</span>
					<span class="sr-only">Previous</span>
				  </a>
				</li>
				<li class="page-item">
				  <a class="page-link" href="coffee.php" aria-label="Next">
