...
<?php include('navigation.php')?>
    ...
    <input type="text" name="id" placeholder="Enter Id for Search" value="<?php if(isset($_POST['id'])){ echo $_POST['id'];}?>" /><br>
            ...
            <table  style="border: medium solid skyblue ;" border="3" width="80%";>
              ...
              <tbody>
                <tr>
				 ...
				 <td><button class="btn btn-outline-danger" name="update" type="submit">Update</button></td>
                 </form>
